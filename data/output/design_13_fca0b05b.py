...
try:
    ...
    try:
        ...
        if current_obj:
            ...
            h1_tool.Radius = 5
            h1_tool.Height = 10
            h1_tool.Placement = App.Placement(App.Vector(50, 50, -10/2), App.Rotation(0,0,0))
    ...
    doc.saveAs('/home/aayush/Downloads/viva-cad-ai/data/output/design_13_fca0b05b.FCStd')
    ...
    if visible_objs:
        Part.export(visible_objs, '/home/aayush/Downloads/viva-cad-ai/data/output/design_13_fca0b05b.step')
        __objs_to_export__ = []
        ...
        Mesh.export(__objs_to_export__, '/home/aayush/Downloads/viva-cad-ai/data/output/design_13_fca0b05b.stl')
