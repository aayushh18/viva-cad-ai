...
try:
    doc = App.newDocument('fallback_part')
    ...
    doc.saveAs('/home/aayush/Downloads/viva-cad-ai/data/output/design_6_cd24da2c.FCStd')
    ...
    if visible_objs:
        Part.export(visible_objs, '/home/aayush/Downloads/viva-cad-ai/data/output/design_6_cd24da2c.step')
        __objs_to_export__ = []
        ...
        Mesh.export(__objs_to_export__, '/home/aayush/Downloads/viva-cad-ai/data/output/design_6_cd24da2c.stl')
