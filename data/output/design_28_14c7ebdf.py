...
# Create hollow boss
boss_out = Part.makeCylinder(30, 20)
boss_in = Part.makeCylinder(25, 20)
...
try:
    ...
    if doc:
        ...
        if objs:
            Part.export(objs, r'../data/output/design_28_14c7ebdf.step')
        doc.saveAs(r'../data/output/design_28_14c7ebdf.FCStd')
