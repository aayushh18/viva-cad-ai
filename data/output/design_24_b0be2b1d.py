...
sbox_2.Placement.Base = App.Vector(cx - (80.0-5.0)/2, cy - 5.0/2, -5)

scyl1_2 = doc.addObject("Part::Cylinder", "SlotCyl1_2")
scyl1_2.Radius = 5.0/2
scyl1_2.Height = 10.0 + 10 if 10.0 else 50
scyl1_2.Placement.Base = App.Vector(cx - (80.0-5.0)/2, cy, -5)

scyl2_2 = doc.addObject("Part::Cylinder", "SlotCyl2_2")
scyl2_2.Radius = 5.0/2
scyl2_2.Height = 10.0 + 10 if 10.0 else 50
scyl2_2.Placement.Base = App.Vector(cx + (80.0-5.0)/2, cy, -5)
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_24_b0be2b1d.FCStd")
