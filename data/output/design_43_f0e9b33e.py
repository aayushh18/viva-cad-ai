...
for x, y in [(10,10), (100,10), (10,100), (100,100)]:
    ...
    base_plate = base_plate.fuse(leg)
...
# Flow Meter (Further down the line)
...
# Final Fuse
final_plant = base_plate.fuse(tank).fuse(p_out).fuse(valve).fuse(flow_meter)
...
try:
    ...
    if doc:
        ...
        if objs:
            Part.export(objs, r'../data/output/design_43_f0e9b33e.step')
        doc.saveAs(r'../data/output/design_43_f0e9b33e.FCStd')
