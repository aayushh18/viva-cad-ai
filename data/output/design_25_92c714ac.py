...
if 5.0*2 <= min(200.0,150.0):
    ...
    cut_cyl_3.Radius = 5.0
    cut_cyl_3.Height = 10.0 + 10 if 10.0 else 50
    cut_cyl_3.Placement.Base = App.Vector(200.0/2, 150.0/2, -5)
    doc.recompute()
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_25_92c714ac.FCStd")
