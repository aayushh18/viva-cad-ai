...
if 9.0*2 <= min(165.0,165.0):
    ...
    cut_cyl_2.Placement.Base = App.Vector(165.0/2, 165.0/2, -5)
    doc.recompute()
...
if 9.0*2 <= min(165.0,165.0):
    ...
    cut_cyl_3.Placement.Base = App.Vector(165.0/2, 165.0/2, -5)
    doc.recompute()
...
if 9.0*2 <= min(165.0,165.0):
    ...
    cut_cyl_4.Placement.Base = App.Vector(165.0/2, 165.0/2, -5)
    doc.recompute()
...
if 9.0*2 <= min(165.0,165.0):
    ...
    cut_cyl_5.Placement.Base = App.Vector(165.0/2, 165.0/2, -5)
    doc.recompute()
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_31_50dc52c9.FCStd")
