...
sbox_2.Length = 80.0 - 10.0
sbox_2.Width = 10.0
sbox_2.Height = 10.0 + 10 if 10.0 else 50
if 100.0 is not None and 80.0 is not None:
    cx, cy = 100.0/2, 80.0/2
else:
    cx, cy = 0, 0

sbox_2.Placement.Base = App.Vector(cx - (80.0-10.0)/2, cy - 10.0/2, -5)

scyl1_2 = doc.addObject("Part::Cylinder", "SlotCyl1_2")
scyl1_2.Radius = 10.0/2
scyl1_2.Height = 10.0 + 10 if 10.0 else 50
scyl1_2.Placement.Base = App.Vector(cx - (80.0-10.0)/2, cy, -5)

scyl2_2 = doc.addObject("Part::Cylinder", "SlotCyl2_2")
scyl2_2.Radius = 10.0/2
scyl2_2.Height = 10.0 + 10 if 10.0 else 50
scyl2_2.Placement.Base = App.Vector(cx + (80.0-10.0)/2, cy, -5)
...
boss_3.Height = 10.0
if 100.0 is not None and 80.0 is not None:
    boss_3.Placement.Base = App.Vector(100.0/2, 80.0/2, 10.0 if 10.0 else 0)
else:
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_23_1f6b27d9.FCStd")
