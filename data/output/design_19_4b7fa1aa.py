...
if 100.0 is not None and 100.0 is not None:
    cx, cy = 100.0/2, 100.0/2
else:
    cx, cy = 0, 0
...
boss_2.Height = 10.0
if 100.0 is not None and 100.0 is not None:
    boss_2.Placement.Base = App.Vector(100.0/2, 100.0/2, 10.0 if 10.0 else 0)
else:
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_19_4b7fa1aa.FCStd")
