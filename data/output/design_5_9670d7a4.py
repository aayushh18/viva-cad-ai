...
try:
    ...
    doc.saveAs('/home/aayush/Downloads/viva-cad-ai/data/output/design_5_9670d7a4.FCStd')
    ...
    if visible_objs:
        Part.export(visible_objs, '/home/aayush/Downloads/viva-cad-ai/data/output/design_5_9670d7a4.step')
        __objs_to_export__ = []
        ...
        Mesh.export(__objs_to_export__, '/home/aayush/Downloads/viva-cad-ai/data/output/design_5_9670d7a4.stl')
