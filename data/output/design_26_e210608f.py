...
boss_3.Height = 10.0
if 200.0 is not None and 150.0 is not None:
    boss_3.Placement.Base = App.Vector(200.0/2, 150.0/2, 10.0 if 10.0 else 0)
else:
...
App.ActiveDocument.saveAs("/home/aayush/Downloads/viva-cad-ai/data/output/design_26_e210608f.FCStd")
